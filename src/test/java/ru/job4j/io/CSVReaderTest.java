...
public class CSVReaderTest {
    ...
    public void whenFieldsNotExist() throws Exception {
        String data = String.join(
                System.lineSeparator(),
                "name;age;last_name;education",
                "Tom;20;Smith;Bachelor",
        ...
        File target = temporaryFolder.newFile("target.csv");
        ArgsName argsName = ArgsName.of(new String[]{
                "-path=" + file.getAbsolutePath(), "-delimiter=;", "-out=" + target.getAbsolutePath(), "-filter=nam,ag"
        });
        Files.writeString(file.toPath(), data);
        CSVReader.handle(argsName);
    }
    ...
    @Test(expected = IllegalArgumentException.class)
    public void whenFieldsNotExist2() throws Exception {
        String data = String.join(
                System.lineSeparator(),
                "name;age;last_name;education",
                "Tom;20;Smith;Bachelor",
